...
def create_app() -> web.Application:
    ...
    app.router.add_post("/api/accounts/{name}/login/start", api_login_start)
    app.router.add_get("/api/accounts/{name}/login/status", api_login_status)
    app.router.add_post("/api/accounts/{name}/login/stop", api_login_stop)
